...
test_that("Can plot using freshly generated forecasts", {
  ...
  expect_ggplot(plot_voc_frac(posterior2))
  expect_ggplot(plot_voc_frac(posterior2, current_obs))
  expect_ggplot(plot_voc_frac(posterior2, current_obs, all_obs = FALSE))
})
