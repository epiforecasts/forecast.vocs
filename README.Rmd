...
Plot posterior estimates for the growth rate over the mean of the generation time for COVID-19 cases (here assumed to be 5.5 days).

```{r}
plots$growth
```

Plot posterior estimates for the effective reproduction number of
Delta, non-Delta cases, combined, and overall (i.e without using strain data).
