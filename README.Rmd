...
Summarise posterior estimates for key model parameters (using the `summary()` method for `forecasts()` posterior predictions and forecasts can also be returned for cases, estimated variant proportions, and variant transmission advantages. See the documentation for details).
